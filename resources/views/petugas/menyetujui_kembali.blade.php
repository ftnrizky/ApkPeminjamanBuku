...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-72 bg-[#062c21] text-white flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 px-6 space-y-2">
            ...
            <a href="/petugas/menyetujui_pengembalian" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-600 shadow-lg shadow-emerald-900/20 text-white transition-all">
